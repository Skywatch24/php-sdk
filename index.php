...
$html .= "<a target=\"_blank\" href=\"https://beta.skywatch24.com/oauth2.php?app_id=1&redirect_uri=http://localhost:8888/skywatch/index.php\" > Link to Skywatch </a>";

$html .= generate_title('Get Device List', 'h3');
$html .= generate_description("id 為 device 的序號，用來對 Device 做資料查詢及操作。可透過 model_id = 63 判斷裝置是否為電子門鎖。");
...
$html .= generate_description("cameraStatusCode = online|offline 表示裝置連線或離線, params['switch_control'] = 0|1 表示門鎖開啟或鎖上");
generate_form($html, 'api.php', 'get', function(&$html) {
    global $auth_code;
...
$html .= generate_description("遠端開關電子門鎖");
generate_form($html, 'api.php', 'get', function(&$html) {
    global $auth_code;
